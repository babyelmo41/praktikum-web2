            ...
            <div class="card-body">
                <form method="POST" action="?page=matakuliah-add" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sks" min="1" max="6" placeholder="Masukan SKS..." required>
                    </div>
                    <div class="form-group">
                        <label for="semester" class="control-label">Semester</label>
                        <input type="number" class="form-control" name="semester" min="1" max="14" placeholder="Masukan Semester..." required>
                    </div>
